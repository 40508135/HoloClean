...
class Logistic(Estimator, torch.nn.Module):
    ...
    def __init__(self, env, dataset, domain_df, active_attrs):
        ...
        ***
        """
        print("The optimizer for the estimation process is")
        self._optimizer = optim.SGD(self.parameters(), lr=self.env['learning_rate'], momentum=self.env['momentum'], weight_decay=0.001)
